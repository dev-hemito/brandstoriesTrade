...
const TicketPlans = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const checkResponse = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/check-registration-evolve`, {
        method: 'POST',
      ...
      const registrationResponse = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/register-evolve`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          ...formData,

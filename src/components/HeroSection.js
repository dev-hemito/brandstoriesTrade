...
const CountdownTimer = () => {
  ...
  return (
    <div className="flex gap-4 my-8">
      <div className="bg-white/5 md:px-6 md:py-4 rounded-xl backdrop-blur-sm text-center">
        <div className="md:text-3xl font-bold text-blue-400">{timeLeft.days}</div>
        <div className="text-sm text-blue-200">Days</div>
      </div>
      <div className="bg-white/5 md:px-6 md:py-4 rounded-xl backdrop-blur-sm text-center">
        <div className="md:text-3xl font-bold text-blue-400">{timeLeft.hours}</div>
        <div className="text-sm text-blue-200">Hours</div>
      </div>
      <div className="bg-white/5 md:px-6 md:py-4 rounded-xl backdrop-blur-sm text-center">
        <div className="md:text-3xl font-bold text-blue-400">{timeLeft.minutes}</div>
        <div className="text-sm text-blue-200">Minutes</div>
      </div>
      <div className="bg-white/5 md:px-6 md:py-4 rounded-xl backdrop-blur-sm text-center">
        <div className="md:text-3xl font-bold text-blue-400">{timeLeft.seconds}</div>
        ...
        <div className="container mx-auto md:px-6 px-3 pt-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-4 ">
              <div className=" md:p-4  space-y-2 items-center gap-3 pt-4 rounded-lg backdrop-blur-sm">
              ...
              <div className="flex flex-wrap gap-8 md:text-lg">
